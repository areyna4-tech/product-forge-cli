...
export const fieldAliases: Record<string, string[]> = {
  ...
  compareAtPrice: ["compare at price", "variant compare at price", "msrp", "list price", "compare price"],
  cost: ["cost", "cost per item", "unit cost", "wholesale price"],
  category: ["category", "product category", "collection", "department"],
  vendor: ["vendor", "supplier", "manufacturer"],
  brand: ["brand", "brand name"],
  quantity: ["quantity", "qty", "stock", "inventory", "variant inventory qty", "inventory quantity"],
  imageUrl: ["image", "image url", "image src", "main image", "photo"],
  weight: ["weight", "product weight", "variant grams"],
